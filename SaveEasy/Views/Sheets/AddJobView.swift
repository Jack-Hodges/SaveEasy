                    ...
                    ScrollView {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            LazyVGrid(columns: columns) {
                                ForEach(authViewModel.user!.linkedAccounts) { child in
                        ...
                        ZStack {
                            ...
                            Button("Add Job") {
                                if jobName != "" {
                                    ...
                                    authViewModel.dataManager.pushChildJobs(users: authViewModel.user!.linkedAccounts, pushTo: selectedChildEmails, newJob: newJob)
