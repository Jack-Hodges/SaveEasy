//
//  JobSegmentAssigned.swift
//  SaveEasy
//
//  Created by Jack Hodges on 15/6/2024.
//

import SwiftUI

struct JobSegmentAssigned: View {
    
    @State var job: Job
    @ObservedObject var authViewModel: AuthViewModel
    @Environment(\.colorScheme) var colorScheme
    @State var jobCol: Color = .gray
    @State var assignees: [String]
...
#Preview {
    JobSegmentAssigned(job: sampleJobs[0], authViewModel: AuthViewModel(), assignees: ["Jack"])
}
